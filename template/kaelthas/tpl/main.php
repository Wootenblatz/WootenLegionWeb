                                    ...
                                    <div class="box1" style="margin-top: 10px;padding: 10px;">
                                        ...
                                        <?php if (get_config('battlenet_register')) { ?>
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control required" placeholder="1..5"
                                                       name="numberOfAccounts" min="1" max="5" step="1">
                                            </div>
                                        <?php } ?>
                                        <div class="input-group">
...
//                                    $i++;
        ...
        <div class="col-md-4 sidebar">
            ...
            <div class="box1">
                Discord
                <hr style="border-color: #F1A40F;">
                <iframe src="https://discordapp.com/widget?id=291115666097045506&theme=dark" width="330"
